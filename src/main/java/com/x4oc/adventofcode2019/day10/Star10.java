package com.x4oc.adventofcode2019.day09;
...
import static com.x4oc.adventofcode2019.day09.Star09.Comparison.*;
import static com.x4oc.adventofcode2019.day09.Star09.Operation.*;

public class Star09 {
    private static final Logger logger = LoggerFactory.getLogger(Star09.class);
    ...
    public static void execute(){
        ...
        String fileName = "./src/main/resources/dataStar09.txt";
    ...
    private static Long calculate(List<Long> opcodes, long input) {
        boolean halt = false;
        int position = 0;
        long result = 0L;
